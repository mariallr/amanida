...
**Note:** output is restricted to 30 features to facilitate the readability. To visualize less features increase `counts` parameter. 
...
**Note:** output is restricted to 25 features to facilitate the readability. To visualize less features increase `counts` parameter. 
...
**Note**: features with both up-regulated and down-regulated tendencies points to low consistency. 
